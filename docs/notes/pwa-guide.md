...
>
> ⚠️ **边界说明**：Service Worker 基础注册与缓存策略见 [浏览器笔记](/notes/browser-note)，HTTP/缓存见 [网络协议笔记](/notes/network-protocol)。本文聚焦 **PWA 完整体系**——安装、推送、后台同步、离线优先等进阶能力。
>
> 📅 基于以下版本：Chrome 120+ | Safari 17+ | Firefox 120+
>
> 🔗 Service Worker 基础注册见 [浏览器笔记](/notes/browser-note)，HTTP/缓存见 [网络协议笔记](/notes/network-protocol)
